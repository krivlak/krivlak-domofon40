...
namespace domofon40
{
    public partial class дом1вид : Form
    {
        public дом1вид()
        {
            InitializeComponent();
        ...
        private void дом1вид_Load(object sender, EventArgs e)
        {
            temp.Moving -= temp_Moving;
            try
            {
                string sqlString = "дом1вид @вид='" + клВид_услуги.вид_услуги.ToString() + "' , @дом='"+клДом.дом.ToString()+"'";

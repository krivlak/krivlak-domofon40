...
namespace domofon40
{
    public partial class все_услуги : Form
    {
        public все_услуги()
        {
            InitializeComponent();
        ...
        private void все_услуги_Load(object sender, EventArgs e)  
        {
            ...
            try
            {
                ...
                string шаблон = curDir + @"\все_услуги.sql";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            string шаблон = curDir + @"\монтажники1вид.docx";
            ...
            try
            {
                using (WordprocessingDocument package = WordprocessingDocument.Open(tempFile, true))
                {
                    ...
                    foreach (temp kRow in listTemp.Where(n => n.отключить))
                    {
                        ...
                        клXML.ChangeTextInCell(table2, j, 0, kRow.наимен_услуги);
                        клXML.ChangeTextInCell(table2, j, 1, kRow.адрес);
                        ...
                        клXML.ChangeTextInCell(table2, j, 5, kRow.телефон);
                    ...
                    клXML.ChangeTextInCell(table2, j, 2, "Всего квартир");
                    клXML.ChangeTextInCell(table2, j, 3, j.ToString());
                    клXML.ChangeTextInCell(table2, j, 4, "");
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            object шаблон = curDir + @"\по_видам2.dot";
            if (!System.IO.File.Exists(шаблон.ToString()))
            {
                MessageBox.Show("Нет файла " + шаблон.ToString());
                return;
                ...
                .Where(n => n.отключить))
            {
                ...
                o.Tables[4].Cell(j, 2).Range.Text = kRow.наимен_улицы.Trim();
                o.Tables[4].Cell(j, 3).Range.Text = kRow.номер_дома.ToString("0;#;#");
                o.Tables[4].Cell(j, 4).Range.Text = kRow.корпус.Trim();
                o.Tables[4].Cell(j, 5).Range.Text = kRow.квартира.ToString("0;#;#");
                o.Tables[4].Cell(j, 6).Range.Text = kRow.ввод.ToString("0;#;#");
                o.Tables[4].Cell(j, 7).Range.Text = kRow.фио;
                o.Tables[4].Cell(j, 8).Range.Text = kRow.долг_мес.ToString("0;#;#");
                o.Tables[4].Cell(j, 9).Range.Text = kRow.телефон;
        ...
        //        foreach (temp kRow in listTemp)
        //        {
        //            kRow.отключить = false;
        //        }
        //        button3.Text = "Отметить все";
        //    }
        //}
    }
}

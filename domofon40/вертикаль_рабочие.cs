...
namespace domofon40
{
    public partial class вертикаль_рабочие : Form
    {
        public вертикаль_рабочие()
        {
            InitializeComponent();
        }
        DateTime maxData;
        ...
        private void вертикаль_рабочие_Load(object sender, EventArgs e)
        {
            ...
            dsТабель1.вертикаль.ColumnChanged += Вертикаль_ColumnChanged;

        }

        private void Вертикаль_ColumnChanged(object sender, DataColumnChangeEventArgs e)
        {
                   if(e.Column== dsТабель1.вертикаль.Columns["раб_дней"])
            {

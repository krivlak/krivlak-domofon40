...
namespace domofon40
{
    public partial class монтажники1вид : Form
    {
        public монтажники1вид()
        {
            InitializeComponent();
        }
        ...
        private void монтажники1вид_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string шаблон = curDir + @"\монтажники1вид.sql";
                ...
                //                string sqlString = "монтажники1вид @вид='" + клВид_услуги.вид_услуги.ToString() + "'";

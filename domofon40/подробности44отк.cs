...
namespace domofon40
{
    public partial class подробности44отк : Form
    {
        public подробности44отк()
        {
            InitializeComponent();
        }
        domofon40.domofon14Entities de = new domofon14Entities();
        List<temp> tempList = new List<temp>();
        private void подробности44отк_Load(object sender, EventArgs e)
        {
            ...
            foreach (var uRow in query)
            {
                ...
                NewRow.отключение = uRow.отключение;
        ...
        class temp
        {
            public Guid отключение { get; set; }

...
namespace domofon40
{
    public partial class одна_услуга : Form
    {
        public одна_услуга()
        {
            InitializeComponent();
        ...
        private void одна_услуга_Load(object sender, EventArgs e)
        {
            temp.Moving -= temp_Moving;
            try
            {
                string sqlString = "одна_услуга  @услуга='" + клУслуга.услуга.ToString() + "'";

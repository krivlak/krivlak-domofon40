...
namespace domofon40
{
    public partial class выбор1реестра : Form
    {
        public выбор1реестра()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string шаблон = curDir + @"\выбор1реестра.docx";
            ...
            try
            {
                using (WordprocessingDocument package = WordprocessingDocument.Open(tempFile, true))
                {
                    ...
                    клXML.ChangeTextInCell(table0, 0, 0, наименФилиала);
                    клXML.ChangeTextInCell(table0, 0, 1, клСотрудник.deRow.фио);
                   ...
                   //     клXML.ChangeTextInCell(table2, j, 2, rRow.фио);
                        клXML.ChangeTextInCell(table2, j, 2, rRow.наимен_вида_оплаты);
                        клXML.ChangeTextInCell(table2, j, 3, rRow.сумма.ToString());
                        клXML.ChangeTextInCell(table2, j, 4, rRow.за_день.ToString());
                        всего += rRow.сумма;
                    }

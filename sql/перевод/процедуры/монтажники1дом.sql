...
/****** Object:  StoredProcedure [dbo].[монтажники1дом]    Script Date: 06.08.2016 20:31:11 ******/
SET ANSI_NULLS ON
GO
...
create  procedure [dbo].[монтажники1дом]
(
...
update @MyTable  set фио= клиенты.фио, квартира=клиенты.квартира, ввод=клиенты.ввод, 
